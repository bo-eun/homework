...
public class BookRestController {
    ...
    //도서한권 삭제
    @DeleteMapping("/books/{bkCode}")
    public ResponseEntity<ApiResponse<?>> deleteBook(@PathVariable("bkCode")String bkCode) throws Exception {

        return ResponseEntity.ok().body(ApiResponse.ok(bookService.deleteBook(bkCode)));
    }
}
