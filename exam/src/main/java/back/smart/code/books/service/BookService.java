...
public class BookService {
    ...
    public Map<String, Object> getBooksList(Pageable pageable) throws Exception {
        ...
        Page<BooksEntity> booksPage = booksRepository.findAllByUseYn(pageable,"Y");
        List<BooksDTO.Response> bookList =
                booksPage.getContent().stream()
                        .filter(entity -> entity.getUseYn().equals("Y"))
    ...
    public ApiResponse<String> createBooks(BooksDTO.Request request) throws Exception {
        ...
        request.setBkCode(newCode);

        BooksEntity entity = BooksDTO.Request.to(request);
    ...
    @Transactional
    public ApiResponse<String> deleteBook(String bkCode) throws Exception {
