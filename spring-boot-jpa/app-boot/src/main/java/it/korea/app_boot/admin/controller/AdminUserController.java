...
public class AdminUserController {
    ...
    @GetMapping("/list")
    public ModelAndView listView(@PageableDefault(page = 0, size = 10, sort = "createDate", direction= Direction.DESC) Pageable pageable) {
        ModelAndView view = new ModelAndView();
        Map<String, Object> resultMap = new HashMap<>();

        try {
            resultMap = service.getUserList(pageable);
