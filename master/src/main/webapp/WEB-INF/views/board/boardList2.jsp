...
<style>
	.container {display: flex; flex-direction: column; align-items: center; margin-top: 7vh;}
	.contents {width: 100%}
	.data-list {width: 100%; min-height: 600px; margin-top: 30px;}
</style>
</head>
<body>
...
<script>
	...
	function drawTable(data) {
		...
		$.each(data.dataList, function(index, obj) {
			...
			link.on('click', () => goDetail(obj.brdId));
			...
			tr.append(makeTD('', obj.like_count));
