...
/**
 * currentPage는 display 1, 값은 0 부터 시작
 * 이유는 계산하기 쉽다.
 * nowBlock도 0 부터 시작
 */
public class PageVO {
	...
	private int blockPerCount; // 한 블럭 당 보여줄 페이지 개수
	...
	public void makePageData() {
		...
		// 현재 블럭 위치
		double nowBlock = (double) this.currentPage / this.blockPerCount;
	...
	public String pageHTML() {
		...
		for(int i = 0; i < this.blockPerCount; i++) {
			...
			// i값은 위치, (this.nowBlock * this.blockPerCount) 블럭 당 시작 값
